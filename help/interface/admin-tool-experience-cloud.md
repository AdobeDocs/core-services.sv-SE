...
# Visa användare och profiler för Experience Cloud i [!UICONTROL Admin Tool]
...
1. Under [!UICONTROL Quick Access], klicka **[!UICONTROL Admin Tool]**.
