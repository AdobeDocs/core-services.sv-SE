...
description: Ta en titt där du kan dra nytta av de AI-baserade funktionerna i Experience Cloud-programmen. Lär dig vilka program som använder AI Assistant (genAI) och agell AI och var du hittar hjälp.
...
# Generativ AI i Experience Cloud-program
...
## Vilka AI-funktioner stöds i Experience Cloud? {#ai-roundup}

Här är en demo av Experience Cloud-program som använder AI-funktioner, AI Assistant eller agauthenticala AI-funktioner. Kompatibilitet med [Adobe Firefly](https://business.adobe.com/products/firefly-business/firefly-ai-approach.html) har angetts.
