...
description: Hitta hjälp med generativ AI (GenAI) och AI-assistenten i Experience Cloud-program.
...
Här är en demo av Experience Cloud-program som använder GenAI, AI Assistant eller agauthenticisk AI. Kompatibilitet med [Adobe Firefly](https://business.adobe.com/products/firefly-business/firefly-ai-approach.html) har angetts.

| **Produktnamn** | **Generativ AI** | **AI-assistenten** | **Firefly-kompatibilitet** | Resurser |
|------------------|-------------------------|------------------|-------------------|------------|
| **Adobe GenStudio for Performance Marketing** | GenStudio for Performance Marketing är en genAI-applikation. Det hjälper marknadsförings- och kreativa team att skapa personaliserat varumärkesanpassat innehåll. | Ej tillämpligt | Ja | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/en/docs/genstudio-for-performance-marketing/user-guide/home" tooltip="Gå till GenStudio for Performance Marketing"} |
| **Adobe Experience Manager Sites** | GenAI används i [Generera variationer](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor?lang=en) för att skapa innehållsvariationer baserade på indata. | Ej tillämpligt | Ja | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor" tooltip="Gå till Generera variationer på Experience League"} |
| **Sites Optimizer** | GenAI hjälper er att analysera och förbättra webbupplevelsernas prestanda och effektivitet. | Ej tillämpligt | Nej | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-manager-sites-optimizer/content/opportunity-types/overview" tooltip="Gå till Sites Optimizer på Experience League"} |
| **Adobe Experience Manager Assets** | GenAI används i [Content Hub](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview?lang=en) och AI-genererade [smarta taggar](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/manage/smart-tags?lang=en#ai-smart-tags). | Ej tillämpligt | Ja | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview" tooltip="Gå till Content Hub på Experience League"} |
| **Adobe Journey Optimizer** | Ej tillämpligt | Finns för produktkunskap och driftsinsikter. | Nej | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/en/docs/journey-optimizer/using/get-started/ai-assistant" tooltip="Läs om AI Assistant i AJO"} |
| | | _AJO Prime_ och _Ultimate_ erbjuder [innehållsgenerering](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/content-management/ai-assistant/gs-generative?lang=en) för att ge proaktiva variantförslag för text och bilder. | Ja | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/en/docs/journey-optimizer/using/content-management/ai-assistant/gs-generative" tooltip="Läs om AI Assistant i AJO"} |
| **Adobe Journey Optimizer B2B edition** | Ej tillämpligt | Finns för att hjälpa till med produktkännedom. | Nej | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/en/docs/journey-optimizer-b2b/user/ai-assistant/ai-assistant-overview" tooltip="Läs om AI Assistant i AJO"} |
| **[!DNL Campaign]hanterade molntjänster** | Ej tillämpligt | Finns för Content Accelerator för automatisk generering av personaliserat, engagerande och effektivt innehåll baserat på marknadsföringsmål i olika kanaler som e-post, SMS och Push | Ja | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/en/docs/campaign-web/v8/content/ai-assistant/generative-gs" tooltip="Läs om AI Assistant i AJO"} |
| **[!DNL Customer Journey Analytics]** | GenAI används med:<ul><li> [Intelligenta bildtexter](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/intelligent-captions?lang=en): För information om de vanligaste Workspace-visualiseringarna.</li><li>[Content Analytics](https://experienceleague.adobe.com/en/docs/analytics-platform/using/content-analytics/report/report?lang=en#template): Om du vill tilldela metadata för resurser automatiskt.</li></ul> | Finns för:<ul><li>[Produktkunskap](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/ai-assistant?lang=en) (Experience League)</li><li>[Produktsupportagent](https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/new-features/customer-support?lang=en) </li><li>[Agenten för datainsikter](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/data-analysis-ai)</li></ul> | Nej | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-workspace/visualizations/intelligent-captions" tooltip="Läs om intelligenta bildtexter"} |
| **Real-Time CDP** | Ej tillämpligt | Finns för produktinformation från Experience League. Här finns även användbara insikter (i betaversion). | Nej | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/home" tooltip="Läs om Real-Time CDP"} |
| **[!DNL Marketo]** | GenAI är tillgängligt i [Dynamic Chat](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/dynamic-chat/generative-ai/overview?lang=en) och [Interaktiva webbinarier](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/events/interactive-webinars/gen-ai?lang=en). | AI Assistant i Marketo Engage [Email Designer](https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/email-marketing/email-designer/ai-assistant) hjälper dig att skapa aktuella, avancerade och intuitiva e-postmeddelanden. | Ja | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/demand-generation/events/interactive-webinars/gen-ai?lang=en" tooltip="Läs om AI i Workfront"} |
| **[!DNL Workfront]** | GenAI används med [information och förslag i appen](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en). | Ej tillämpligt | Ja | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview" tooltip="Läs om AI Assistant i Workfront"} |

## Hur du kan använda GenAI i Experience Cloud {#products}
