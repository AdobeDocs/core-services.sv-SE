...
description: Läs mer om generativ AI (GenAI) och hur Experience Cloud-program använder GenAI och [!UICONTROL AI Assistant].
...
Den här typen av AI är kontrasterad med [agentisk AI](agentic-ai.md) (Adobe agentiska ramverk), som refererar till AI som fungerar självständigt.
...
Här är en demo av Experience Cloud-program som använder GenAI, AI Assistant eller agauthenticisk AI. Kompatibilitet med Adobe Firefly anges.
