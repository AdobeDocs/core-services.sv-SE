...
| [Adobe Journey Optimizer](#journey-optimizer) | Ej tillämpligt | Finns för produktkunskap och driftsinsikter. | Nej | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/sv/docs/journey-optimizer/using/get-started/ai-assistant" tooltip="Läs om AI Assistant i AJO"} |
...
| [[!DNL Adobe Journey Optimizer] B2B edition](#ajo-b2b) | Ej tillämpligt | Finns för att hjälpa till med produktkännedom. | Nej | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/sv/docs/journey-optimizer-b2b/user/ai-assistant/ai-assistant-overview" tooltip="Läs om AI Assistant i AJO"} |
...
| [[!DNL Real-Time CDP]](#rtcdp) | Ej tillämpligt | Finns för produktinformation från Experience League. Här finns även användbara insikter (i betaversion). | Nej | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/sv/docs/experience-platform/ai-assistant/home" tooltip="Läs om Real-Time CDP"} |
