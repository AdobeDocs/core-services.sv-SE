...
|------------------|-------------------------|------------------|---------------------------|
| [Adobe GenStudio for Performance Marketing](#gspm) | GenStudio for Performance Marketing är en genAI-applikation. Det hjälper marknadsförings- och kreativa team att skapa personaliserat varumärkesanpassat innehåll. | Ej tillämpligt | Ja |
| [Adobe Experience Manager Sites](#aem) | GenAI används i [Generera variationer](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor?lang=en) för att skapa innehållsvariationer baserade på indata. | Ej tillämpligt | Ja |
| [Sites Optimizer](#aem) | GenAI hjälper er att analysera och förbättra webbupplevelsernas prestanda och effektivitet. | Ej tillämpligt | Nej |
...
| [Adobe Journey Optimizer](#journey-optimizer) | Ej tillämpligt | Finns för produktkunskap och driftsinsikter. | Nej |
...
| [[!DNL Adobe Journey Optimizer] B2B edition](#ajo-b2b) | Ej tillämpligt | Finns för att hjälpa till med produktkännedom. | Nej |
| [[!DNL Campaign] Hanterade molntjänster](#campaign-cs) | Ej tillämpligt | Finns för Content Accelerator för automatisk generering av personaliserat, engagerande och effektivt innehåll baserat på marknadsföringsmål i olika kanaler som e-post, SMS och Push | Ja |
...
| [[!DNL Real-Time CDP]](#rtcdp) | Ej tillämpligt | Finns för produktinformation från Experience League. Här finns även användbara insikter (i betaversion). | Nej |
...
| [[!DNL Workfront]](#workfront) | GenAI används med [information och förslag i appen](https://experienceleague.adobe.com/en/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en). | Ej tillämpligt | Ja |
