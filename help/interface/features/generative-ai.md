...
Följande Experience Cloud-program har stöd för generativ AI eller [!UICONTROL AI Assistant]. Support för Adobe Firefly anges också per produkt.

Uppdaterat: **9 juni 2025**
...
* [Product Support Agent](https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/new-features/customer-support) för att skapa supportärenden, komplett med kontext- och sessionsinformation från dina interaktioner med AI Assistant.
* [Data Insights Agent](https://experienceleague.adobe.com/en/docs/analytics-platform/using/cja-overview/cja-b2c-overview/data-analysis-ai) för svar på frågor om dina data. Det bygger upp relevanta visualiseringar i Analysis Workspace med komponenter från datavyn och med era faktiska data.
