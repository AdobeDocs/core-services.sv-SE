...
* **Produktkunskap:** Produktkunskap avser begrepp och ämnen som anges i Experience League-dokumentationen. Lär dig hur du skapar effektiva, [målinriktade uppmaningar](https://experienceleague.adobe.com/en/docs/experience-platform/ai-assistant/home) för att få ut så mycket som möjligt av Experience Platform. Alla svar från Experience League kan verifieras och anges med länkar.
...
>[!NOTE]
>
>I många Experience Cloud-program finns _AI Assistant_ som funktionsnamn (se nedan). Den här funktionen hämtar dock information endast för det program du använder. Exempel: AI Assistant i AEM ger endast relevant och användbar information om AEM.
