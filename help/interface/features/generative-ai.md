...
| **Adobe Experience Manager Sites** | GenAI används i [Generera variationer](https://experienceleague.adobe.com/sv/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor?lang=en) för att skapa innehållsvariationer baserade på indata. | Ej tillämpligt | Ja | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/sv/docs/experience-manager-cloud-service/content/generative-ai/generate-variations-integrated-editor" tooltip="Gå till Generera variationer på Experience League"} |
| **Sites Optimizer** | GenAI hjälper er att analysera och förbättra webbupplevelsernas prestanda och effektivitet. | Ej tillämpligt | Nej | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/sv/docs/experience-manager-sites-optimizer/content/opportunity-types/overview" tooltip="Gå till Sites Optimizer på Experience League"} |
| **Adobe Experience Manager Assets** | GenAI används i [Content Hub](https://experienceleague.adobe.com/sv/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview?lang=en) och AI-genererade [smarta taggar](https://experienceleague.adobe.com/sv/docs/experience-manager-cloud-service/content/assets/manage/smart-tags?lang=en#ai-smart-tags). | Ej tillämpligt | Ja | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/sv/docs/experience-manager-cloud-service/content/assets/content-hub/product-overview" tooltip="Gå till Content Hub på Experience League"} |
| **Adobe Journey Optimizer** | Ej tillämpligt | Finns för produktkunskap och driftsinsikter. | Nej | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/sv/docs/journey-optimizer/using/get-started/ai-assistant" tooltip="Läs om AI Assistant i AJO"} |
...
| **[!DNL Workfront]** | GenAI används med [information och förslag i appen](https://experienceleague.adobe.com/sv/docs/workfront/using/basics/ai-assistant/ai-assistant-overview?lang=en). | Ej tillämpligt | Ja | [!BADGE Läs mer]{type=Informative url="https://experienceleague.adobe.com/sv/docs/workfront/using/basics/ai-assistant/ai-assistant-overview" tooltip="Läs om AI Assistant i Workfront"} |
