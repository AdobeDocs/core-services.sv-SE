...
| **(endast Adobe Target)** Överför data från [!DNL Customer Attributes] till Adobe Target förlänga Adobe Target besökares livslängd? | Ja. Se [Livstid för besökarprofil](https://experienceleague.adobe.com/docs/target/using/audiences/visitor-profiles/visitor-profile.html?lang=en) i Adobe Target Help. |
