...
Adobe sammanfogar inte information på webbläsarnivå över olika företag. För att skydda kundens integritet och säkerhet erbjuder vissa av tjänsterna i Experience Cloud företag möjligheten att använda en separat uppsättning cookies för varje webbplats som spåras. Vissa av Suite-erbjudandena erbjuder även kunder möjlighet att använda sitt eget domännamn som ägare av cookien. Detta skapar ett extra lager av sekretess och säkerhet, eftersom cookies från *första part* från Experience Cloud skapas, som permanent tillhör företagets webbplats.
