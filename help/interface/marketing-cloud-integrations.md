...
* Aktivering - Dynamic Tag Management eller Experience Platform Launch
* Analyser
* Mål
...
* [Segmentering](https://docs.adobe.com/content/help/en/analytics/integration/audience-analytics/audience-analytics-workflow/aam-analytics-segments.html) i Audience Manager
...
Arbeta med data från Experience Cloud-lösningar eller andra externa system i Audience Manager.
...
Använd Experience Cloud Activation-lösningarna för att konfigurera och felsöka era Experience Cloud-lösningar.
...
Hjälp (inloggning krävs): [Integrering med Adobe Experience Cloud-lösningar och bastjänster](https://enterprise.efrontier.com/CMDashboard/help/internal/concepts_and_features/media_optimizer_integration_with_adobe_marketing_cloud.htm)
