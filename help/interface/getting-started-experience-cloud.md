...
>[!IMPORTANT]
>
>Administratörer kan läsa [Administration](admin-getting-started.md#topic_3FCB4099640647E3B2411ADBFCE81909) för information om uppdateringar av användar- och produkthantering.
...
| Element | Beskrivning |
|--- |--- |
| [Grundläggande om Admin Console](experience-cloud.md) | Läs mer om de första stegen du måste ta för att komma igång med lösningar från Experience Cloud. |
...
| [Starta Admin Console](admin-getting-started.md) | Admin Console är den centrala platsen för hantering av användare i Adobe och produktbehörigheter i hela organisationen.<br>Du kan också logga in på Admin Console med en  [direktlänk](https://adminconsole.adobe.com). |
...
1. Kontrollera med administratören att din [organisation](organizations.md) har etablerats i Experience Cloud.
...
1. På landningssidan väljer du väljarikonen ![](assets/menu-icon.png) för att öppna den nedrullningsbara menyn.
   ...
   Vilka lösningar och tjänster som visas på den här menyn beror på vilka programbehörigheter din [administratör](admin-getting-started.md#topic_3FCB4099640647E3B2411ADBFCE81909) har.
