...
| Problem | Beskrivning |
|--- |--- |
| [!DNL Customer Attribute] prenumerationsbegränsningar | När du uppgraderar till Analytics Premium tar det 24 timmar innan fler attribut finns tillgängliga. Ett [!UICONTROL attribute Subscription Max]-fel kan ha uppstått under fördröjningen. |
