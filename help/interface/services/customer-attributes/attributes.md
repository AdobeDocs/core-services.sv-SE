...
* **Adobe Target** `at.js` (valfri version) eller `mbox.js` version 58 eller senare krävs för kundattribut.
  ...
  Se [Så här distribuerar du at.js](https://experienceleague.adobe.com/docs/target-dev/developer/client-side/overview.html).
...
Se [Överför kundattributdata](t-crs-usecase.md) om du vill lära dig detta arbetsflöde.
