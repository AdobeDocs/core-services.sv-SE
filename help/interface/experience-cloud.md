...
1. Kontrollera att du är i rätt organisation.
   ...
   ![Verifiera att du är i rätt organisation](assets/organizations-menu.png){width="100" zoomable="yes"}
...
![Öppna Experience Cloud-program](assets/platform-core-services.png){width="100" zoomable="yes"}
...
![Få hjälp och support](assets/search-menu.png){width="100" zoomable="yes"}
...
![Meddelanden och meddelanden](assets/notifications-menu-small.png){width="100" zoomable="yes"}
